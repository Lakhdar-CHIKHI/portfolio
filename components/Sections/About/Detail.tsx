  ...
  return (
    ...
    >
      ...
      <Text variant="description">
        ...
        and driving cross-functional collaboration. I’m dedicated to delivering quality in every project I undertake and always excited to explore innovative technologies while continuously expanding my skill set.
        <br /> <br />
        Here are few {' '}
